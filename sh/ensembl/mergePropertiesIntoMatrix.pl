...
=head1 EXAMPLES
  ...
  mergePropertiesIntoMatrix.pl -indir <directory_with_files_to_merge> -species <species> -bioentity <bioentity type>

  E.g.
  mergePropertiesIntoMatrix.pl -indir $ATLAS_PROD/bioentity_properties/ensembl/ -bioentity gene -species homo_sapiens
...
#Test arguments
if (!$indir ) { warn "[WARNING] Missing input (-indir) directory\n" ; $help  = 1 ; }
if (!$bioentity || !$species) { warn "[WARNING] Missing species (-species) or bioentity (-bioentity)\n" ; $help  = 1 ; }
