...
# After the script is run, the annotation source config files need to be commited and pushed to git, so that they are propagated to /nfs/ma/home/atlas3-production/sw/atlasinstall_prod/atlasprod
